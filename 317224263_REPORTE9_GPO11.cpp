...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Reporte08", nullptr, nullptr);
	...
	Model Banca((char*)"Models/Proyecto/Banca/banca.obj");
	Model Bote((char*)"Models/Proyecto/Bote/bote.obj");
	Model Maceta((char*)"Models/Proyecto/Maceta/maceta.obj");
	Model Burbuja((char*)"Models/Proyecto/Burbuja/burbuja.obj");
	Model Roca((char*)"Models/Proyecto/Roca/roca.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Directional light
		// INTENSIDAD = AMBIENTE (0 ES NEGRO, 0.8 CLARO)
		// COLOR = DIFUSION (0 ES NEGRO, 0.8 CLARO)
		// AMBIENTE Y DIFUSION PUEDE TAMBIEN MOSTRAR SOLO UN COLOR DE RGB
		// ESPECULAR 0=Brillo Bajo, 1=Brillo Maximo
		...
		glUniform1f(glGetUniformLocation(lightingShader.Program, "pointLights[3].quadratic"), 1.0f);

		// SpotLight
		//CONTANTE SIEMPRE 1
		//CONO INTERNO SIEMPRE MAS PEQUEÑO QUE EL EXTERNO
		//AMBIENTE Y DIFUSION DETERMINAN EL COLOR DE LA LINTERNA
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.diffuse"), 1.0f, 0.0f, 0.0f);
